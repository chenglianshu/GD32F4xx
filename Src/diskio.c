...
#ifdef GD32F4xx
#define SD_INIT_SPEED       256
#define SD_MAX_SPEED        16
#else
#ifndef FATFS_SPI_PRESCALER
#define FATFS_SPI_PRESCALER SPI_BAUDRATEPRESCALER_16
#endif
#define SD_INIT_SPEED       SPI_BAUDRATEPRESCALER_256
#define SD_MAX_SPEED        (FATFS_SPI_PRESCALER & SPI_BAUDRATEPRESCALER_256)
#endif

static spi_slave_t dev = {
    .cs_pin = SD_CS_PIN,
    .cs_port = (void *)SD_CS_PORT,
    .f_clock = SD_INIT_SPEED
};
